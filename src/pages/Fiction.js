...
const Fiction = () => {
  ...
  const [fictionnList, setFictionnList] = useState([]);
  ...
  const getData = () => {
    fetch("http://skunkworks.ignitesol.com:8000/books/?topic=fiction")
      .then((response) => {
      ...
      .then((data) => {
        ...
        setFictionnList(transformedData);
      });
  };
