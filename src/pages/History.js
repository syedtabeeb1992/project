...
const History = () => {
  const [historynList, setHistorynList] = useState([]);
  ...
  const getData = () => {
    fetch("http://skunkworks.ignitesol.com:8000/books/?topic=history")
      .then((response) => {
      ...
      .then((data) => {
        ...
        setHistorynList(transformedData);
      });
  };
