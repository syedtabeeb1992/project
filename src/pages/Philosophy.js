...
const Philosophy = () => {
  const [philosophynList, setPhilosophynList] = useState([]);
  ...
  const getData = () => {
    fetch("http://skunkworks.ignitesol.com:8000/books/?topic=philosophy")
      .then((response) => {
      ...
      .then((data) => {
        ...
        setPhilosophynList(transformedData);
      });
  };
